...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-3 md:gap-6">
              <button
                ...
                className="lg:hidden p-1.5 text-zinc-500 hover:text-black hover:bg-zinc-100 rounded-lg focus:outline-none"
              >
                {isSidebarOpen ? <X className="h-5 w-5" /> : <Menu className="h-5 w-5" />}
              </button>
              
              <h1 className="text-xs sm:text-sm font-black uppercase tracking-wider text-black flex items-center gap-1.5 sm:gap-2">
                <span>Calcio Threads</span>
                <span className="text-[9px] sm:text-[10px] uppercase bg-black text-white px-1.5 sm:px-2 py-0.5 rounded-none font-bold tracking-widest">
                  Admin
                </span>
              </h1>
            </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-3">
              <Link href="/">
                <Button variant="ghost" size="icon" className="text-zinc-500 hover:text-black rounded-none hover:bg-zinc-100 h-9 w-9">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="relative text-zinc-500 hover:text-black rounded-none hover:bg-zinc-100 h-9 w-9">
                ...
                <DropdownMenuContent align="end" className="w-72 sm:w-80 bg-white border border-zinc-200 text-black rounded-none shadow-xl">
              ...
              <Button
                ...
                className="text-zinc-500 hover:text-red-600 rounded-none hover:bg-red-50 font-bold text-[10px] sm:text-xs uppercase tracking-wider transition-colors px-2 py-1.5 sm:px-3"
              >
      ...
      {/* Main Content */}
      <main className="lg:ml-64 pt-16 min-h-screen relative z-10 bg-zinc-50 transition-all duration-300">
